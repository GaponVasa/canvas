(Vector2 = function(a, b) {
  ...
  (Vector2.prototype.sub = function(a) {
    return (
      "object" == typeof a && ((this.x -= a.x), (this.y -= a.y)),
      "number" == typeof a && ((this.x -= a), (this.y -= a)),
      this
    );
  }),
  ...
  (random = function() {
    ...
    return 1 == a.length
      ? Math.random() * a[0]
      : 2 == a.length
      ? Math.random() * (Math.max(a[0], a[1]) - Math.min(a[0], a[1])) +
        Math.min(a[0], a[1])
      : void 0;
  }),
  (random = function(a, b) {
